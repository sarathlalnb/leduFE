      ...
      >
        ...
        <div className="absolute bottom-6 left-0 right-0 px-6">
          <div className="bg-gradient-to-r from-red-500/20 to-purple-600/20 rounded-lg p-4 text-center">
            ...
            <p className="text-xs mt-1"><span className="bg-gradient-to-r from-red-500 to-purple-600 bg-clip-text text-transparent" style={{fontFamily: "ExpressaSerial-Bold"}}>Ledu.</span><span className="text-slate-400"> Learning Platform</span></p>
          </div>
        </div>
      </aside>
    </>
