              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className={`w-full px-4 py-2 pr-10 border-2 rounded-lg focus:border-transparent focus:ring-2 focus:ring-red-500 outline-none transition-all ${fieldErrors.password ? "border-red-400" : "border-slate-200"
                      }`}
                  />
                  <button
                    type="button"
